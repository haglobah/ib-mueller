...
◊div[#:class "mx-auto max-w-prose"]{
  ◊div[#:class "grid grid-cols-1 xs:grid-cols-2 justify-between gap-6 min-h-[90vh] xs:min-h-[60vh]"]{
    ◊picture-card[#:title "Über mich" #:picture-style "background-image: url(assets/mueller.jpg); background-repeat: no-repeat; background-size: 30rem; background-position: 0% 45%;" #:link "#about-me"]{}
    ◊blank-card[#:title "Konzeption" #:link "#konzeption"]{
    ...
    ◊blank-card[#:title "Gutachten" #:link "#gutachten"]{
      ◊div[#:class "pl-6 pb-4 p-2 font-ibm-plex-sans font-bold"]{
        ◊topics{
    ...
    ◊picture-card[#:title "Beratung" #:picture-style "background-image: url(assets/Beratung.svg); background-repeat: no-repeat; background-size: 18rem;" #:link "#beratung"]{}
  }
